...
public class MatrixConstructor : MonoBehaviour
{
    public GameObject mapBlock01;
    ...
    void Start() //here
    {
        ...
        GameObject.Find("MapCreation").GetComponent<MapController>().goalPathID = finalCode;
        GameObject.Find("MapCreation").GetComponent<MapController>().pathObjArray = new GameObject[finalCode];
        MapBuilder.BuildIt(mazeArray, mapBlock01);
        GameObject.Find("MapCreation").GetComponent<MapController>().FetchPathEncounters();
